-- ============================================================
-- Contractor CRM Schema for contractors2 funnel
-- ============================================================
...
-- Primary contractor CRM records
...
-- Activity log for contractor leads
...
-- Queued followups and reminders
...
-- contractor_activity_log indexes
...
-- Auto-update updated_at on contractor_leads

  ...
  <section className="min-h-screen flex items-center py-24">
    <div className="max-w-6xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      ...
      <div>
        <motion.p
          {...fadeUp}
          className="text-sm font-medium tracking-widest uppercase text-white/50 mb-4"
        >
        ...
        >
          WindowMan gets homeowners after they've already received competitor
          quotes. They upload those estimates, we show them what's wrong, and
          when they want a better option — that opportunity can become yours.
        </motion.p>
        ...
        >
          These are not random leads. These are active buyers already comparing
          quotes and trying to decide who to trust.
        </motion.p>
        ...
        <div className="space-y-5">
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-sm text-white/50 mt-0.5">
                Total is 28% above county median for this scope and window
                count.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-sm text-white/50 mt-0.5">
                No permit handling, no stucco repair, and no debris removal
                listed.
              </p>
            </div>
          </div>

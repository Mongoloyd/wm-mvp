    ...
    <section className="bg-transparent">
      <div ref={ref} className="mx-auto max-w-5xl px-4 md:px-8 py-20 md:py-28 text-center">
        ...
        <motion.div
          ...
          className="mt-8"
        >
          <button onClick={handleScanClick} <button onClick={handleScanClick} className="btn-depth-destructive" style={{ padding: "16px 32px" }}> style={{ padding: "16px 32px" }}>
        ...
        <div className="pt-10 border-t border-border mt-14"></div>
      </div>
    </section>
  );
};

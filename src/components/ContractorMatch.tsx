  ...
  return (
    <motion.div ref={ref} id="contractor-match" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.15 }} style={{ background: "#0A0A0A" }} className="py-16 md:py-24 px-4 md:px-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        {isGoodGrade ? (
          <>
            ...
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 17, color: "#6B7280", lineHeight: 1.75, maxWidth: 580, margin: "14px auto 0" }}>You're in a good position. Before you sign — here's the one question worth asking about the warranty.</p>
            <div className="mx-auto text-left" style={{ maxWidth: 480, marginTop: 32, background: "#111111", border: "1px solid #1A1A1A", borderRadius: 0, padding: "28px 24px" }}>
              ...
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "#6B7280", marginTop: 12, lineHeight: 1.7 }}>Most contractors cover the product but not the labor after year 1. A good warranty covers both for at least 3 years. Ask before you sign.</p>
              <div style={{ borderTop: "1px solid #1A1A1A", margin: "20px 0" }} />
              <button onClick={() => console.log({ event: "wm_comparison_quote_requested", grade })} style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#6B7280", background: "none", border: "none", cursor: "pointer", textDecoration: "underline", padding: 0 }}>Request a comparison quote anyway →</button>
            </div>
          </>
        ) : (
          <>
            ...
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 17, color: "#6B7280", lineHeight: 1.75, maxWidth: 580, margin: "14px auto 0" }}>Based on your grade and the red flags in your quote, I've identified a {county} County contractor in our network who covers your scope at fair-market pricing.<br /><br />I'd like to make an introduction.</p>
            <div className="mx-auto text-left" style={{ maxWidth: 480, marginTop: 32, background: "#111111", border: "1px solid rgba(37,99,235,0.3)", borderRadius: 0, padding: "32px 28px" }}>
              {!introRequested ? (
                <>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "#6B7280" }}>{county} County, Florida · Vetted Q1 2025</p>
                  ...
                  <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#6B7280", lineHeight: 1.9 }}>
                ...
                <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.15 }} className="text-center py-4">
                  ...
                  <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#6B7280", lineHeight: 1.8, marginTop: 12 }}>I've flagged your project. Our contractor will reach out within 2 business hours to schedule your free measurement.<br /><br />They already have your grade report. They know what your current quote missed. The conversation starts where most conversations end.</p>
                  <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 11, color: "#6B7280", marginTop: 16 }}>You can still use your negotiation script with your current contractor. Having options is the point.</p>
                </motion.div>
              )}
            </div>
          </>
          ...
          <div className="flex flex-col gap-3">
            {vetItems.map((item, i) => (
              <div key={i} className="flex items-start gap-2.5">
                ...
                <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#6B7280", lineHeight: 1.6 }}>{item}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto mt-10 text-center">
        ...
        <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 12, color: "#6B7280", fontStyle: "italic", marginTop: 16, lineHeight: 1.8, maxWidth: 520, margin: "16px auto 0" }}>You are under no obligation to contact anyone.<br />WindowMan earns a referral fee only if you choose to work with a matched contractor.</p>
      </div>
    </motion.div>
  );
};

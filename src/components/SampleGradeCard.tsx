...
const AnimatedCounter = ({ target }: { target: number }) => {
  ...
  return <span className="font-mono font-bold text-xl text-wm-orange tabular-nums" style={{ filter: "drop-shadow(0 1px 4px rgba(249, 115, 22, 0.2))" }}>${value.toLocaleString()}</span>;
};

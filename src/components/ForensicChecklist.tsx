        ...
        <div className="relative overflow-hidden glass-card-strong shadow-2xl">
          ...
          <div className="relative z-10 flex gap-4 items-start p-5 border-b border-border">
            <div>
              ...
              <p className="font-body text-[14px] text-muted-foreground leading-relaxed mt-1.5">These questions expose the information asymmetry in every impact window sales pitch. Bring this checklist to your site visit.</p>
            </div>
          </div>
            ...
            {questions.map((q) => (
              <div key={q.id} className="py-6 border-b border-border">
                ...
                <div className="mt-3 bg-muted rounded-lg p-3.5">
                  ...
                  <p className="font-body text-[13px] text-muted-foreground leading-relaxed">{q.why}</p>
                </div>
                <div className="mt-3 bg-card rounded-lg p-3" style={{ borderLeft: `3px solid ${q.askBorder}` }}>
                  ...
                  <p className="font-body text-[14px] text-foreground italic font-medium leading-relaxed">{q.askText}</p>
                </div>
              </div>
            ))}
          </div>

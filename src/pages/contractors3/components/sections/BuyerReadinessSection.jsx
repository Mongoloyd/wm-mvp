...
export default function BuyerReadinessSection() {
  const steps = [
    {
      num: "01",
      title: "The Homeowner Gets a Quote",
      body: "They collect an estimate from a competitor, but feel uneasy about the price, the pressure, or the vague details.",
    },
    {
      num: "02",
      title: "They Upload It Into WindowMan",
      body: "Seeking clarity, they upload the quote. We scan it and expose the red flags: missing permits, unverified specs, inflated labor.",
    },
    {
      num: "03",
      title: "Trust Breaks Down. Motivation Builds.",
      body: "Realizing they almost overpaid for a worse outcome, they want a trustworthy alternative immediately.",
    },
  ];
    ...
    <section className="mx-auto w-full max-w-5xl py-24">
      ...
      <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-8 text-center shadow-lg md:p-12">
        <p className="mx-auto max-w-3xl text-xl font-medium leading-relaxed text-white md:text-2xl">
          "By The Time They Reach You, They Are More Educated, More Emotionally Activated, and More Ready To Move Than
          any Lead You've Worked Before."
        </p>
      </div>
    </section>
  );

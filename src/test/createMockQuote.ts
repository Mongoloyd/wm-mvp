...
export const SCENARIO_FIXTURES: ScenarioFixture[] = [
  {
    ...
    extraction: {
      ...
      line_items: [
        { description: "PGT WinGuard Impact Single Hung Window", quantity: 2, unit_price: 1850, total_price: 3700, brand: "PGT", series: "WinGuard", dp_rating: "DP50", noa_number: "NOA 17-0501.06", dimensions: "36x60" },
        { description: "PGT WinGuard Impact Horizontal Roller", quantity: 1, unit_price: 2200, total_price: 2200, brand: "PGT", series: "WinGuard", dp_rating: "DP50", noa_number: "NOA 17-0501.06", dimensions: "72x48" },
        { description: "CGI Sentinel Impact Sliding Glass Door", quantity: 1, unit_price: 4500, total_price: 4500, brand: "CGI", series: "Sentinel", dp_rating: "DP50", noa_number: "NOA 18-0312.02", dimensions: "96x80" },
        { description: "PGT WinGuard Impact Picture Window - Hurricane rated", quantity: 1, unit_price: 2800, total_price: 2800, brand: "PGT", series: "WinGuard", dp_rating: "DP65", noa_number: "NOA 17-0501.06", dimensions: "60x48" },
      ],
      warranty: { labor_years: 5, manufacturer_years: 25, transferable: true, details: "Manufacturer: limited lifetime on glass seal. Labor: 5-year full coverage including callbacks." },
      permits: { included: true, responsible_party: "contractor", details: "All building permits and final inspection included in quoted price." },
      installation: { scope_detail: "Full removal of existing windows, installation of new impact units, stucco patching, interior/exterior caulking, foam insulation, and final cleanup.", disposal_included: true, accessories_mentioned: true },
    },
  },
  {
    key: "gradeB",
  ...
  },
  {
    ...
    extraction: {
      ...
      line_items: [
        { description: "Impact single hung window", quantity: 3, unit_price: 950, total_price: 2850, brand: "PGT", dimensions: "36x48" },
        { description: "Impact horizontal roller", quantity: 2, unit_price: 1100, total_price: 2200, dimensions: "60x36" },
      ],
  ...
  },
  {
    ...
    extraction: {
      ...
      hvhz_zone: true,
      line_items: [
        { description: "PGT WinGuard Impact Single Hung - hurricane", quantity: 2, unit_price: 1600, total_price: 3200, brand: "PGT", series: "WinGuard", dp_rating: "DP50", dimensions: "36x60" },
        { description: "Impact Sliding Glass Door - storm rated", quantity: 1, unit_price: 3800, total_price: 3800, brand: "CGI", dp_rating: "DP45", dimensions: "72x80" },
      ],
      permits: { included: true, responsible_party: "contractor" },
      installation: { scope_detail: "Remove and replace specified openings. Caulking and cleanup.", disposal_included: true },
    },
  },
  {
    key: "finePrintTrap",
  ...
  },
  {
    ...
    extraction: {
      ...
      line_items: [
        { description: "Impact single hung window - hurricane protection", quantity: 4, unit_price: 1400, total_price: 5600, brand: "ECO", series: "StormMax" },
        { description: "Impact sliding glass door - hurricane protection", quantity: 2, unit_price: 3200, total_price: 6400, brand: "ECO", series: "StormMax" },
      ],
      warranty: { labor_years: 3, manufacturer_years: 15, transferable: false, details: "Limited manufacturer warranty." },
      permits: { included: true, responsible_party: "contractor", details: "Permit fees included." },
      installation: { scope_detail: "Full removal and replacement. Caulk and seal. Disposal of old windows.", disposal_included: true, accessories_mentioned: true },
  ...
  },
  {
    ...
    extraction: {
      ...
      confidence: 0.90,
      line_items: [
        { description: "Kitchen remodel - cabinets and countertops", quantity: 1, unit_price: 15000, total_price: 15000 },
      ],
    },
  },
  {
    ...
    extraction: {
      ...
      confidence: 0.2,
      line_items: [
        { description: "Blurry text - possibly window", quantity: 1 },
      ],
    },
  },
];
